const PaginationHeader = ({ target, className }) => {
    return (
        <div className={`${className} w-full h-20 border-b-2 bg-bg_navy_dark border-gray-300 flex flex-row items-center`}>
            ...
            <div className={`p-5 ${target.includes('skills') ? 'w-[13%]' : 'w-[16%]'} border-r-2 border-gray-300 h-full flex items-center`}><p className="text-white flex justify-center items-center text-sm">Name</p></div>
